-- 2037_mention_notifications.sql
-- Purpose: add mention notification type and emit mention notifications from create_comment_with_rate_limit.

SET search_path = public, extensions;

-- Add mention to notification_type if missing.
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Recreate comment RPC with mention notifications (admin bypass and new_comment preserved).
