-- 0012_admin_moderation_functions.sql – admin RPCs for delete/restore/warn
...
BEGIN
    ...
    SELECT id, user_id INTO v_catch
    FROM public.catches
    WHERE id = p_catch_id
    FOR UPDATE;
...
-- Summary: admin moderation RPCs wired to moderation_log and user_warnings
